...
public:
	...
	using std::enable_shared_from_this<Tile>::shared_from_this;
	std::shared_ptr<Tile> getTile() override final { return shared_from_this(); }
	std::shared_ptr<const Tile> getTile() const override final { return shared_from_this(); }
