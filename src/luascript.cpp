...
int32_t LuaScriptInterface::loadFile(const std::string& file, Npc* npc /* = nullptr*/)
{
	...
	if (ret != 0) {
		reportError(nullptr, tfs::lua::popString(L));
		resetScriptEnv();
		return -1;
	}
...
std::string tfs::lua::getStackTrace(lua_State* L, std::string_view error_desc)
{
                                     ...
                                     bool stack_trace /*= false*/)
{
	...
	if (L && stack_trace) {
		std::cout << tfs::lua::getStackTrace(L, error_desc) << std::endl;
	} else {
...
int tfs::lua::luaErrorHandler(lua_State* L)
{
	std::string_view errorMessage = popString(L);
...
bool LuaScriptInterface::callFunction(int params)
{
	...
	if (tfs::lua::protectedCall(L, params, 1) != 0) {
		LuaScriptInterface::reportError(nullptr, tfs::lua::getString(L, -1));
	} else {
...
void LuaScriptInterface::callVoidFunction(int params)
{
	...
	if (tfs::lua::protectedCall(L, params, 0) != 0) {
		LuaScriptInterface::reportError(nullptr, tfs::lua::popString(L));
	}
...
void LuaScriptInterface::pushVariant(lua_State* L, const LuaVariant& var)
{
	...
	tfs::lua::setField(L, "type", var.type());
	switch (var.type()) {
		case VARIANT_NUMBER:
			tfs::lua::setField(L, "number", var.getNumber());
			break;
		case VARIANT_STRING:
			tfs::lua::setField(L, "string", var.getString());
			break;
	...
	tfs::lua::setMetatable(L, -1, "Variant");
}
...
void LuaScriptInterface::pushThing(lua_State* L, Thing* thing)
{
	if (!thing) {
		...
		tfs::lua::setField(L, "uid", 0);
		tfs::lua::setField(L, "itemid", 0);
		tfs::lua::setField(L, "actionid", 0);
		tfs::lua::setField(L, "type", 0);
		return;
	}
...
void LuaScriptInterface::pushCylinder(lua_State* L, Cylinder* cylinder)
{
	if (Creature* creature = cylinder->getCreature()) {
		...
		tfs::lua::pushUserdata(L, parentItem);
...
void tfs::lua::setField(lua_State* L, const char* index, lua_Number value)
{
	lua_pushnumber(L, value);
	lua_setfield(L, -2, index);
}

void tfs::lua::setField(lua_State* L, const char* index, std::string_view value)
{
	pushString(L, value);
	lua_setfield(L, -2, index);
}
...
{
	Position position;
	position.x = tfs::lua::getField<uint16_t>(L, arg, "x");
	position.y = tfs::lua::getField<uint16_t>(L, arg, "y");
	position.z = tfs::lua::getField<uint8_t>(L, arg, "z");

	lua_getfield(L, arg, "stackpos");
	if (lua_isnil(L, -1) == 1) {
		stackpos = 0;
	} else {
		stackpos = tfs::lua::getNumber<int32_t>(L, -1);
	}
...
Outfit_t LuaScriptInterface::getOutfit(lua_State* L, int32_t arg)
{
	...
	outfit.lookType = tfs::lua::getField<uint16_t>(L, arg, "lookType");
	outfit.lookTypeEx = tfs::lua::getField<uint16_t>(L, arg, "lookTypeEx");

	outfit.lookHead = tfs::lua::getField<uint8_t>(L, arg, "lookHead");
	outfit.lookBody = tfs::lua::getField<uint8_t>(L, arg, "lookBody");
	outfit.lookLegs = tfs::lua::getField<uint8_t>(L, arg, "lookLegs");
	outfit.lookFeet = tfs::lua::getField<uint8_t>(L, arg, "lookFeet");
	outfit.lookAddons = tfs::lua::getField<uint8_t>(L, arg, "lookAddons");

	outfit.lookMount = tfs::lua::getField<uint16_t>(L, arg, "lookMount");
	outfit.lookMountHead = tfs::lua::getField<uint8_t>(L, arg, "lookMountHead");
	outfit.lookMountBody = tfs::lua::getField<uint8_t>(L, arg, "lookMountBody");
	outfit.lookMountLegs = tfs::lua::getField<uint8_t>(L, arg, "lookMountLegs");
	outfit.lookMountFeet = tfs::lua::getField<uint8_t>(L, arg, "lookMountFeet");
...
{
	uint16_t lookType = tfs::lua::getField<uint16_t>(L, arg, "lookType");
	const std::string& name = getFieldString(L, arg, "name");
	bool premium = tfs::lua::getField<uint8_t>(L, arg, "premium") == 1;
	bool unlocked = tfs::lua::getField<uint8_t>(L, arg, "unlocked") == 1;
	lua_pop(L, 4);
...
{
	uint16_t percent = tfs::lua::getField<uint16_t>(L, arg, "percent");
	uint16_t chance = tfs::lua::getField<uint16_t>(L, arg, "chance");
	lua_pop(L, 2);
...
BestiaryInfo LuaScriptInterface::getBestiaryInfo(lua_State* L, int32_t arg)
{
	...
	uint32_t raceId = tfs::lua::getField<uint32_t>(L, arg, "raceId");
	uint32_t prowess = tfs::lua::getField<uint32_t>(L, arg, "prowess");
	uint32_t expertise = tfs::lua::getField<uint32_t>(L, arg, "expertise");
	uint32_t mastery = tfs::lua::getField<uint32_t>(L, arg, "mastery");
	uint32_t charmPoints = tfs::lua::getField<uint32_t>(L, arg, "charmPoints");
	uint32_t difficulty = tfs::lua::getField<uint32_t>(L, arg, "difficulty");
	uint32_t occurrence = tfs::lua::getField<uint32_t>(L, arg, "occurrence");
...
Thing* LuaScriptInterface::getThing(lua_State* L, int32_t arg)
{
	...
	if (lua_getmetatable(L, arg) != 0) {
		lua_rawgeti(L, -1, 't');
		switch (tfs::lua::getNumber<uint32_t>(L, -1)) {
			case LuaData_Item:
				thing = tfs::lua::getUserdata<Item>(L, arg);
				break;
			case LuaData_Container:
				thing = tfs::lua::getUserdata<Container>(L, arg);
				break;
			case LuaData_Teleport:
				thing = tfs::lua::getUserdata<Teleport>(L, arg);
				break;
			case LuaData_Podium:
				thing = tfs::lua::getUserdata<Podium>(L, arg);
				break;
			case LuaData_Player:
				thing = tfs::lua::getUserdata<Player>(L, arg);
				break;
			case LuaData_Monster:
				thing = tfs::lua::getUserdata<Monster>(L, arg);
				break;
			case LuaData_Npc:
				thing = tfs::lua::getUserdata<Npc>(L, arg);
				break;
			default:
				thing = nullptr;
				break;
		...
		thing = getScriptEnv()->getThingByUID(tfs::lua::getNumber<uint32_t>(L, arg));
	}
	return thing;
}
...
{
	if (isUserdata(L, arg)) {
		return tfs::lua::getUserdata<Creature>(L, arg);
	}
	return g_game.getCreatureByID(tfs::lua::getNumber<uint32_t>(L, arg));
}

Player* LuaScriptInterface::getPlayer(lua_State* L, int32_t arg)
{
	if (isUserdata(L, arg)) {
		return tfs::lua::getUserdata<Player>(L, arg);
	}
	return g_game.getPlayerByID(tfs::lua::getNumber<uint32_t>(L, arg));
}
...
void LuaScriptInterface::pushPosition(lua_State* L, const Position& position, int32_t stackpos /* = 0*/)
{
	...
	tfs::lua::setField(L, "x", position.x);
	tfs::lua::setField(L, "y", position.y);
	tfs::lua::setField(L, "z", position.z);
	tfs::lua::setField(L, "stackpos", stackpos);

	tfs::lua::setMetatable(L, -1, "Position");
}

void LuaScriptInterface::pushOutfit(lua_State* L, const Outfit_t& outfit)
{
	lua_createtable(L, 0, 12);
	tfs::lua::setField(L, "lookType", outfit.lookType);
	tfs::lua::setField(L, "lookTypeEx", outfit.lookTypeEx);
	tfs::lua::setField(L, "lookHead", outfit.lookHead);
	tfs::lua::setField(L, "lookBody", outfit.lookBody);
	tfs::lua::setField(L, "lookLegs", outfit.lookLegs);
	tfs::lua::setField(L, "lookFeet", outfit.lookFeet);
	tfs::lua::setField(L, "lookAddons", outfit.lookAddons);
	tfs::lua::setField(L, "lookMount", outfit.lookMount);
	tfs::lua::setField(L, "lookMountHead", outfit.lookMountHead);
	tfs::lua::setField(L, "lookMountBody", outfit.lookMountBody);
	tfs::lua::setField(L, "lookMountLegs", outfit.lookMountLegs);
	tfs::lua::setField(L, "lookMountFeet", outfit.lookMountFeet);
}
...
void LuaScriptInterface::pushOutfit(lua_State* L, const Outfit* outfit)
{
	lua_createtable(L, 0, 4);
	tfs::lua::setField(L, "lookType", outfit->lookType);
	tfs::lua::setField(L, "name", outfit->name);
	tfs::lua::setField(L, "premium", outfit->premium);
	tfs::lua::setField(L, "unlocked", outfit->unlocked);
	tfs::lua::setMetatable(L, -1, "Outfit");
}
...
void LuaScriptInterface::pushLoot(lua_State* L, const std::vector<LootBlock>& lootList)
{
	...
	for (const auto& lootBlock : lootList) {
		...
		tfs::lua::setField(L, "itemId", lootBlock.id);
		tfs::lua::setField(L, "chance", lootBlock.chance);
		tfs::lua::setField(L, "subType", lootBlock.subType);
		tfs::lua::setField(L, "maxCount", lootBlock.countmax);
		tfs::lua::setField(L, "actionId", lootBlock.actionId);
		tfs::lua::setField(L, "text", lootBlock.text);
...
#define registerEnum(L, value) \
	{ \
		...
		tfs::lua::registerGlobalVariable(L, enumName.substr(enumName.find_last_of(':') + 1), value); \
	}
#define registerEnumIn(L, tableName, value) \
	{ \
		std::string enumName = #value; \
		tfs::lua::registerVariable(L, tableName, enumName.substr(enumName.find_last_of(':') + 1), value); \
	}
...
void LuaScriptInterface::registerFunctions()
{
	...
	// _G
	tfs::lua::registerGlobalVariable(L, "INDEX_WHEREEVER", INDEX_WHEREEVER);
	tfs::lua::registerGlobalBoolean(L, "VIRTUAL_PARENT", true);

	tfs::lua::registerGlobalMethod(L, "isType", LuaScriptInterface::luaIsType);
	tfs::lua::registerGlobalMethod(L, "rawgetmetatable", LuaScriptInterface::luaRawGetMetatable);

	// configKeys
	tfs::lua::registerTable(L, "configKeys");
...
void tfs::lua::registerClass(lua_State* L, std::string_view className, std::string_view baseClass,
...
{
	// isValidUID(uid)
	tfs::lua::pushBoolean(L, getScriptEnv()->getThingByUID(tfs::lua::getNumber<uint32_t>(L, -1)) != nullptr);
	return 1;
}
...
{
	// isDepot(uid)
	Container* container = getScriptEnv()->getContainerByUID(tfs::lua::getNumber<uint32_t>(L, -1));
...
int LuaScriptInterface::luaIsMoveable(lua_State* L)
{
	// isMoveable(uid)
	// isMovable(uid)
	Thing* thing = getScriptEnv()->getThingByUID(tfs::lua::getNumber<uint32_t>(L, -1));
...
int LuaScriptInterface::luaItemGetReflect(lua_State* L)
{
	...
	Item* item = tfs::lua::getUserdata<Item>(L, 1);
	if (item) {
		pushReflect(L, item->getReflect(tfs::lua::getNumber<CombatType_t>(L, 2), getBoolean(L, 3, true)));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemGetBoostPercent(lua_State* L)
{
	...
	Item* item = tfs::lua::getUserdata<Item>(L, 1);
	if (item) {
		lua_pushnumber(L, item->getBoostPercent(tfs::lua::getNumber<CombatType_t>(L, 2), getBoolean(L, 3, true)));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaCreatureSetTarget(lua_State* L)
{
	...
	Creature* creature = tfs::lua::getUserdata<Creature>(L, 1);
	if (creature) {
		tfs::lua::pushBoolean(L, creature->setAttackedCreature(getCreature(L, 2)));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaCreatureSetFollowCreature(lua_State* L)
{
	...
	Creature* creature = tfs::lua::getUserdata<Creature>(L, 1);
	if (creature) {
		tfs::lua::pushBoolean(L, creature->setFollowCreature(getCreature(L, 2)));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaCreatureSetMaster(lua_State* L)
{
	...
	tfs::lua::pushBoolean(L, creature->setMaster(getCreature(L, 2)));
...
int LuaScriptInterface::luaPlayerRemoveManaSpent(lua_State* L)
{
	...
	Player* player = tfs::lua::getUserdata<Player>(L, 1);
	if (player) {
		player->removeManaSpent(tfs::lua::getNumber<uint64_t>(L, 2), getBoolean(L, 3, true));
		tfs::lua::pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaMonsterIsInSpawnRange(lua_State* L)
{
	...
	if (monster) {
		tfs::lua::pushBoolean(L,
		                      monster->isInSpawnRange(lua_gettop(L) >= 2 ? getPosition(L, 2) : monster->getPosition()));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaHouseKickPlayer(lua_State* L)
{
	...
	tfs::lua::pushBoolean(L, house->kickPlayer(getPlayer(L, 2), getPlayer(L, 3)));
	return 1;
}
...
{
	// Combat()
	tfs::lua::pushSharedPtr(L, g_luaEnvironment.createCombatObject(getScriptEnv()->getScriptInterface()));
...
int LuaScriptInterface::luaCombatSetCallback(lua_State* L)
{
	...
	tfs::lua::pushBoolean(L, callback->loadCallBack(getScriptEnv()->getScriptInterface(), function));
	return 1;
}
