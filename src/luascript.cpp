                   ...
                   lua_CFunction newFunction = nullptr)
{
	...
	if (className == "Item") {
		tfs::lua::pushNumber(L, LuaData_Item);
	} else if (className == "Container") {
		tfs::lua::pushNumber(L, LuaData_Container);
	} else if (className == "Teleport") {
		tfs::lua::pushNumber(L, LuaData_Teleport);
	} else if (className == "Podium") {
		tfs::lua::pushNumber(L, LuaData_Podium);
	} else if (className == "Player") {
		tfs::lua::pushNumber(L, LuaData_Player);
	} else if (className == "Monster") {
		tfs::lua::pushNumber(L, LuaData_Monster);
	} else if (className == "Npc") {
		tfs::lua::pushNumber(L, LuaData_Npc);
	} else if (className == "Tile") {
		tfs::lua::pushNumber(L, LuaData_Tile);
	} else {
		tfs::lua::pushNumber(L, LuaData_Unknown);
	}
...
int LuaScriptInterface::luaNetworkMessageTell(lua_State* L)
{
	...
	NetworkMessage* message = tfs::lua::getUserdata<NetworkMessage>(L, 1);
	if (message) {
		tfs::lua::pushNumber(L, message->getBufferPosition() - message->INITIAL_BUFFER_POSITION);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetBaseMaxHealth(lua_State* L)
{
	...
	Player* player = tfs::lua::getUserdata<Player>(L, 1);
	if (player) {
		tfs::lua::pushNumber(L, player->healthMax);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetBaseMaxMana(lua_State* L)
{
	...
	Player* player = tfs::lua::getUserdata<Player>(L, 1);
	if (player) {
		tfs::lua::pushNumber(L, player->manaMax);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetSkillLevel(lua_State* L)
{
	...
	if (player && skillType <= SKILL_LAST) {
		tfs::lua::pushNumber(L, player->skills[skillType].level);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetSkillPercent(lua_State* L)
{
	...
	Player* player = tfs::lua::getUserdata<Player>(L, 1);
	if (player && skillType <= SKILL_LAST) {
		tfs::lua::pushNumber(L, player->skills[skillType].percent);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetSkillTries(lua_State* L)
{
	...
	Player* player = tfs::lua::getUserdata<Player>(L, 1);
	if (player && skillType <= SKILL_LAST) {
		tfs::lua::pushNumber(L, player->skills[skillType].tries);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetMaxSoul(lua_State* L)
{
	...
	if (player && player->vocation) {
		tfs::lua::pushNumber(L, player->vocation->getSoulMax());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerAddItemEx(lua_State* L)
{
	...
	tfs::lua::pushNumber(L, returnValue);
	return 1;
}
...
int LuaScriptInterface::luaPlayerShowTextDialog(lua_State* L)
{
	...
	tfs::lua::pushNumber(L, player->windowTextId);
	return 1;
}
...
int LuaScriptInterface::luaPlayerGetPremiumEndsAt(lua_State* L)
{
	...
	Player* player = tfs::lua::getUserdata<Player>(L, 1);
	if (player) {
		tfs::lua::pushNumber(L, player->premiumEndsAt);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetFightMode(lua_State* L)
{
	...
	Player* player = tfs::lua::getUserdata<Player>(L, 1);
	if (player) {
		tfs::lua::pushNumber(L, player->fightMode);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPartyGetMemberCount(lua_State* L)
{
	...
	Party* party = tfs::lua::getUserdata<Party>(L, 1);
	if (party) {
		tfs::lua::pushNumber(L, party->getMemberCount());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPartyGetInviteeCount(lua_State* L)
{
	...
	Party* party = tfs::lua::getUserdata<Party>(L, 1);
	if (party) {
		tfs::lua::pushNumber(L, party->getInvitationCount());
	} else {
		lua_pushnil(L);
	}
	return 1;
