...
void loadContainer(OTB::iterator& first, const OTB::iterator& last, Container* container);

void loadItem(OTB::iterator& first, const OTB::iterator& last, Cylinder* parent)
{
