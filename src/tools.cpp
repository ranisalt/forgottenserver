...
auto depotBoxes =
    std::vector{ITEM_DEPOT_BOX_I,   ITEM_DEPOT_BOX_II,   ITEM_DEPOT_BOX_III,  ITEM_DEPOT_BOX_IV,  ITEM_DEPOT_BOX_V,
                ...
                ITEM_DEPOT_BOX_XVI, ITEM_DEPOT_BOX_XVII, ITEM_DEPOT_BOX_XVIII};
...
uint16_t getDepotBoxId(uint16_t index)
{
	...
	return static_cast<uint16_t>(depotBoxes[index]);
}
